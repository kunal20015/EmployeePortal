...
">
  ...
  <div style="display:flex;gap:12px;">
    ...
    <a href="loginemp" style="text-decoration:none;color:#fff;padding:10px 16px;border-radius:10px;">Login</a>
  </div>
</div>
...
">
  ...
  <h1 style="margin:0 0 18px;font-size:26px;color:#fff;">Employee Registration</h1>

 <!-- Centered JSP message (styled) -->
<div style="display:flex;justify-content:center;margin-bottom:14px;">
  ...
  <!-- SERVLET USED -->
  <form action= "registerEmployee" method="post" style="display:flex;flex-direction:column;gap:16px;">
    ...
    <select name="gender" required style="padding:14px;border-radius:10px;border:none;font-size:15px;">
